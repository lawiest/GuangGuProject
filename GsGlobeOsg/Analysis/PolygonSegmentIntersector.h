#ifndef GEOGLOBE_POLYGONSEGEMENTINTERSECTOR_H
#define GEOGLOBE_POLYGONSEGEMENTINTERSECTOR_H 1
...
namespace GeoGlobe
{
	class PolygonSegmentIntersector : public GeoGlobe::Intersector
	{
		public:
			PolygonSegmentIntersector(std::vector<osg::Vec3d>& vecGeoPts);
		...
		public:
			...
			virtual Intersector* clone(GeoGlobe::IntersectionVisitor& iv);

			virtual bool enter(const osg::Node& node);

			virtual void leave();

			virtual void intersect(GeoGlobe::IntersectionVisitor& iv, osg::Node* node);
		...
		protected:
			...
			PolygonSegmentIntersector* _parent;
