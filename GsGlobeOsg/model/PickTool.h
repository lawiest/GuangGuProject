...
//						cout<<_selectedModel->_options->_feature->getFeatureName()<<endl;
						__android_log_print(ANDROID_LOG_INFO, "SelectedModel", "Feature: %lld", _selectedModel->_options->_feature->getFeatureID());
						__android_log_print(ANDROID_LOG_INFO, "SelectedModel", "FeatureName: %s", (_selectedModel->_options->_feature->getFeatureName()).c_str());
