...
class /*DLL_EXPORT*/ ThirdVersatileVertex3dWithoutRGB : public Vertex3d
{
...
public:
    ...
    */
	...
	//** 创建日期： 2013-08-27
	//**********************************************************************************
    ThirdVersatileVertex3dWithoutRGB(double dblx = 0.0,double dbly = 0.0,
	...
	//** 创建日期： 2012-04-16
	//**********************************************************************************
    ThirdVersatileVertex3dWithoutRGB(Vertex3d& vPos,Vertex3d& vNor,double dblu,double dblv,double dblu2,double dblv2,double dblu3,double dblv3);


    /** 构造函数3
    */
    ThirdVersatileVertex3dWithoutRGB(Vertex3d& vPos,Vertex3d& vNor,Vertex2d& vTex,Vertex2d& vTex2,Vertex2d& vTex3);
