//********************************************************************************** 
//** 文件名称：CT3D_VersatileVertex3fWithoutRGB.h
...
{
	/** @defgroup VersatileVertex3fWithoutRGB VersatileVertex3fWithoutRGB-全有顶点  
    *  @{
    */
...
public:
	...
	/** @defgroup VersatileVertex3fWithoutRGB 操作（成员函数）
	* @{
	*/
