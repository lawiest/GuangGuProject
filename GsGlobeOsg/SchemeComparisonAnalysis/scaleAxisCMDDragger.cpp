...
ScaleAxisCMDDragger::ScaleAxisCMDDragger(osg::ref_ptr<osg::Vec3dArray> m_modelWorldVertices):_modelWorldVertices(m_modelWorldVertices)
{
...
//设置该拖拽器默认形状
void ScaleAxisCMDDragger::setupDefaultGeometry()
{
	//方向线
