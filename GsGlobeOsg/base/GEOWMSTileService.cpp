...
GEOWMSTilePattern::GEOWMSTilePattern(const std::string& pattern)
{
    _pattern = pattern;
    init();
}
...
void GEOWMSTilePattern::getTileBounds(const int &x, const int &y, double &minX, double &minY, double &maxX, double &maxY)
{
...
std::string GEOWMSTilePattern::getRequestString(const int &x, const int &y)
{
...
GEOWMSTileService::GEOWMSTileService():
_dataMin(-180, -90),
_dataMax(180, 90)
{
}

void GEOWMSTileService::getMatchingPatterns(const std::string &layers, const std::string &format,
...
const Profile*
GEOWMSTileService::createProfile(TilePatternList &patterns)
{
...
GEOWMSTileService* 
GEOWMSTileServiceReader::read( const std::string &location, const osgDB::ReaderWriter::Options* options )
{
    GEOWMSTileService *tileService = NULL;
...
namespace
{
    ...
    void addTilePatterns(XmlElement* e_root, GEOWMSTileService* tileService)
    {
...
GEOWMSTileService*
GEOWMSTileServiceReader::read(std::istream &in)
{
    osg::ref_ptr<GEOWMSTileService> tileService = new GEOWMSTileService;
