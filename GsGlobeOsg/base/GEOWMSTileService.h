 ...
 */
class GEOWMSTilePattern
{
public:
    GEOWMSTilePattern(const std::string &pattern);
...
private:
    friend class GEOWMSTileServiceReader;
...
class GEOWMSTileService : public osg::Referenced
{
public:
    GEOWMSTileService();

    /** A list of TilePatterns */
    typedef std::vector<GEOWMSTilePattern> TilePatternList;
...
private:
    ...
    std::vector<GEOWMSTilePattern> _patterns;
};
 ...
 */
class GEOWMSTileServiceReader
{
public:
    static GEOWMSTileService* read( const std::string &location, const osgDB::ReaderWriter::Options* options);
    static GEOWMSTileService* read( std::istream &in );
private:
    GEOWMSTileServiceReader(){}
    GEOWMSTileServiceReader(const GEOWMSTileServiceReader &tsr){}
};
