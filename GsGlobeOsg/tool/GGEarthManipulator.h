 ...
 */
#ifndef GEOGLOBE_TOOL_GGEARTHMANIPULATOR
#define GEOGLOBE_TOOL_GGEARTHMANIPULATOR
...
GLOBE_NS
     ...
     */
    class GS_API EarthManipulator : public osgGA::CameraManipulator
    {
    public:
    ...
    public:
		...
		const Viewpoint& getHomeViewpoint();
		...
		virtual void rotateByZ(double dDelta);

		//virtual void setViewpointByZ(const Viewpoint& vp, double duration_seconds);
    ...
    protected:
		...
		void getEulerAnglesByZ(const osg::Quat& quat, double* azim, double* pitch) const;
...
GS_SMARTER_PTR(EarthManipulator);

GLOBE_ENDNS

typedef GLOBE_NAME::EarthManipulator GGEarthManipulator;
