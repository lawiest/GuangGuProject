...
//    m_ribbonStyle->setDPIAware(false);
    ...
    QAction* actionAbout = ribbonBar()->addAction(QIcon("./Resources/res/about.png"), tr("About"), Qt::ToolButtonIconOnly);
    actionAbout->setToolTip(tr("Display program<br />information, version number and copyright"));
    connect(actionAbout, SIGNAL(triggered()), this, SLOT(about()));

    m_actionRibbonMinimize = ribbonBar()->addAction(QIcon("./Resources/res/ribbonMinimize.png"), tr("Minimize the Ribbon"), Qt::ToolButtonIconOnly);
    ...
    connect(ribbonBar(), SIGNAL(minimizationChanged()), this, SLOT(minimizationChanged()));
